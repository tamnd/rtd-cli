---
title: "rtd"
description: "Browse and search ReadTheDocs documentation projects"
heroTitle: "rtd, from the command line"
heroLead: "Browse and search ReadTheDocs documentation projects One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
rtd links <path>           # the pages it links to, each addressable
rtd serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading rtd by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address rtd as
  `rtd://` URIs and follow links across sites. See
