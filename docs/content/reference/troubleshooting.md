...
Most of these come down to network reality or how rtd serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

rtd rate-limits like any public site. rtd already paces
...
Where a surface is gated, rtd reads a cookie or token you supply
...
`rtd`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what rtd actually did
